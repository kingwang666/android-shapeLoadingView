...
public class ShapeView extends View {
    ...
    private void init() {
        mTriangleColor = ContextCompat.getColor(getContext(), R.color.triangle);
        mCircleColor = ContextCompat.getColor(getContext(), R.color.circle);
        mRectColor = ContextCompat.getColor(getContext(), R.color.rect);
        mPaint = new Paint();
